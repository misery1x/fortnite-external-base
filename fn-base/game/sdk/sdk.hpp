...
public:
	static camera_position_s GetCamera()
	{
		...
		uintptr_t location_pointer = ReadMemory<uintptr_t>(cache.UWorld + 0x170);
		uintptr_t rotation_pointer = ReadMemory<uintptr_t>(cache.UWorld + 0x180);
		FNRot fnrot{};
...
public:
	...
	{
		double Seconds = ReadMemory<double>(cache.UWorld + 0x190);
